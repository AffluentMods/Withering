...
public abstract class Weapon {
    ...
    public Weapon(String name, int damageFrom, int damageTo, Rarity rarity) {
        this(name, damageFrom, damageTo, rarity, true);
    }

    public Weapon(String name, int damageFrom, int damageTo, Rarity rarity, boolean addToList) {
        this.name = name;
    ...
    public AttackRate getAttackRate() {
        if (this instanceof Bow) return AttackRate.SLOW;
        else if (this instanceof Sword) return AttackRate.DECENT;
        else return AttackRate.QUICK;
    }
