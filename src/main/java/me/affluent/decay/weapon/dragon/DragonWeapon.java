...
public abstract class DragonWeapon {

    private final String name;
    private final int damageFrom;
    private final int damageTo;
    private final Rarity rarity;
    private static final HashMap<String, DragonWeapon> weapons = new HashMap<>();

    public DragonWeapon(String name, int damageFrom, int damageTo, Rarity rarity) {
        this(name, damageFrom, damageTo, rarity, true);
    }

    public DragonWeapon(String name, int damageFrom, int damageTo, Rarity rarity, boolean addToList) {
        this.name = name;
    ...
    public static DragonWeapon getWeapon(String name) {
