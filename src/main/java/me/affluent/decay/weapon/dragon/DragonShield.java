...
public class DragonShield {
    ...
    private static final HashMap<String, DragonShield> shield = new HashMap<>();

    public DragonShield(String name, int protection) {
        this.name = name;
        this.protection = protection;
        shield.put(name.toLowerCase(), this);
    }

    public static DragonShield getDragonShield(String name) {
