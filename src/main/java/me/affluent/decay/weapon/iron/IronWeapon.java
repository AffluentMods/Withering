...
public abstract class IronWeapon {

    private final String name;
    private final int damageFrom;
    private final int damageTo;
    private final Rarity rarity;
    private static final HashMap<String, IronWeapon> weapons = new HashMap<>();

    public IronWeapon(String name, int damageFrom, int damageTo, Rarity rarity, boolean addToList) {
        this.name = name;
    ...
    public static IronWeapon getWeapon(String name) {
