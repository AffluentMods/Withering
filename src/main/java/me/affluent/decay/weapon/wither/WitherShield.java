...
public class WitherShield {
    ...
    private static final HashMap<String, WitherShield> shield = new HashMap<>();

    public WitherShield(String name, int protection) {
        this.name = name;
        this.protection = protection;
        shield.put(name.toLowerCase(), this);
    }

    public static WitherShield getWitherShield(String name) {
