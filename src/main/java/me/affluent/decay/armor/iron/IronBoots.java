...
import me.affluent.decay.armor.Boots;
...
public class IronBoots implements Armor {
    ...
    private static final HashMap<String, IronBoots> ironBoots = new HashMap<>();

    public IronBoots(String name, int protectionFrom, int protectionTo, Rarity rarity) {
        this(name, protectionFrom, protectionTo, rarity, true);
    }

    public IronBoots(String name, int protectionFrom, int protectionTo, Rarity rarity, boolean addToList) {
        this.name = name;
    ...
    public static IronBoots getIronBoots(String name) {
