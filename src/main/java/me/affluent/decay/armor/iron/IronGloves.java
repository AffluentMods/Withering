...
public class IronGloves implements Armor {

    private final String name;
    private final int protectionFrom;
    private final int protectionTo;
    private final Rarity rarity;
    private static final HashMap<String, IronGloves> ironGloves = new HashMap<>();

    public IronGloves(String name, int protectionFrom, int protectionTo, Rarity rarity) {
        this(name, protectionFrom, protectionTo, rarity, true);
    }

    public IronGloves(String name, int protectionFrom, int protectionTo, Rarity rarity, boolean addToList) {
        this.name = name;
    ...
    public static IronGloves getIronGloves(String name) {
