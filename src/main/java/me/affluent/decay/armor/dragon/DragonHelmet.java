...
public class DragonHelmet implements Armor {

    private final String name;
    private final int protectionFrom;
    private final int protectionTo;
    private final Rarity rarity;
    private static final HashMap<String, DragonHelmet> ironHelmet = new HashMap<>();

    public DragonHelmet(String name, int protectionFrom, int protectionTo, Rarity rarity) {
        this(name, protectionFrom, protectionTo, rarity, true);
    }

    public DragonHelmet(String name, int protectionFrom, int protectionTo, Rarity rarity, boolean addToList) {
        this.name = name;
    ...
    public static DragonHelmet getDragonHelmet(String name) {
