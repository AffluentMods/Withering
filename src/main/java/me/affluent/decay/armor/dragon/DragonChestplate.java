...
public class DragonChestplate implements Armor {

    private final String name;
    private final int protectionFrom;
    private final int protectionTo;
    private final Rarity rarity;
    private static final HashMap<String, DragonChestplate> ironChestplate = new HashMap<>();

    public DragonChestplate(String name, int protectionFrom, int protectionTo, Rarity rarity) {
        this(name, protectionFrom, protectionTo, rarity, true);
    }

    public DragonChestplate(String name, int protectionFrom, int protectionTo, Rarity rarity, boolean addToList) {
        this.name = name;
    ...
    public static DragonChestplate getDragonChestplate(String name) {
