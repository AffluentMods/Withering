...
public class WitherChestplate implements Armor {

    private final String name;
    private final int protectionFrom;
    private final int protectionTo;
    private final Rarity rarity;
    private static final HashMap<String, WitherChestplate> ironChestplate = new HashMap<>();

    public WitherChestplate(String name, int protectionFrom, int protectionTo, Rarity rarity) {
        this(name, protectionFrom, protectionTo, rarity, true);
    }

    public WitherChestplate(String name, int protectionFrom, int protectionTo, Rarity rarity, boolean addToList) {
        this.name = name;
    ...
    public static WitherChestplate getWitherChestplate(String name) {
